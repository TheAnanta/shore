  ...
  return (
    <div className="min-h-screen bg-[#090909] text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-[600px] bg-[#161616] backdrop-blur-md p-3 rounded-4xl border-2 border-zinc-800/60 shadow-2xl z-10"
      >
              ...
              <div className="space-y-4 text-center">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <button
                    onClick={handleGoogleLogin}
                    disabled={loading}
                    className="cursor-pointer w-max px-8 mx-auto bg-white text-black hover:bg-gray-200 font-bold py-3 rounded-2xl transition-colors flex items-center justify-center gap-3"
                  >
                    {/* Google Icon SVG */}
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                      <path
