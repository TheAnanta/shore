...
export default function LandingSection() {
    return <section style={{
        ...
        <img loading="lazy" fetchPriority="low" src="/images/landing/landing-section-bg.png" style={{
            height: 'calc(100vh - 44px)',
            position: 'absolute',
            objectFit: 'cover',
            top: 0,
        ...
        <img loading="eager" fetchPriority="high" className="scale-400 bottom-16 md:bottom-0 md:scale-100" src="/images/landing/bottom-border.png" style={{
            position: 'absolute',
            left: 0,
            width: '100%',
            zIndex: 3,
        }} />
        <img loading="eager" fetchPriority="high" className="hidden md:block md:scale-100" src="/images/landing/rock_right.svg" style={{
            position: 'absolute',
            height: '45vh',
            bottom: '-60px',
            right: 0,
        ...
        <img loading="eager" fetchPriority="high" className="scale-150 md:scale-100 bottom-[-100px] md:bottom-[-60px]" src="/images/landing/rock_left.svg" style={{
            position: 'absolute',
            height: '45vh',
            left: 0,
            zIndex: 2,
        ...
        <img loading="eager" fetchPriority="high" className="hidden md:block md:scale-100" src="/images/landing/dolphin-right.png" style={{
            position: 'absolute',
            height: '45vh',
            bottom: '19vh',
            right: '5vw',
        ...
        <div className="z-10 relative flex flex-col items-center justify-center">
            ...
            <h3 className="mt-10 md:mt-0 text-[1rem] md:text-xl font-extrabold uppercase text-white/70">30<sup className="lowercase">th</sup> Jan - 1<sup className="lowercase">st</sup> Feb 2026</h3>

            <img src={"/images/landing/downward-arrow.svg"} className="size-10 translate-y-8" />
        </div>
        <img loading="eager" fetchPriority="high" className="hidden md:block md:scale-100 h-[38vh] left-[20%] z-1 md:h-[45vh] relative bottom-[-6vh] md:bottom-[19vh] md:left-[5vw] md:absolute" src="/images/landing/dolphin-left.png" />
        <img loading="eager" fetchPriority="high" className="md:hidden px-6 md:scale-100 z-10 md:h-[45vh] relative bottom-[-5vh] -rotate-6 -translate-x-6 md:bottom-[19vh] md:left-[5vw] md:absolute" src="/images/landing/gitfin-relaxing.png" />
    </section>
}