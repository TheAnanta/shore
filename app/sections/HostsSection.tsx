...
/*
0. Manas Malla - Lead, Technology
1. Mohammed Rehan - President 
2. ⁠Darshan Visinigiri - Head of Marketing 
3. ⁠Pratham Varma - Head Of Management 
4. ⁠Akash Puligora - Head Of Events 
5. ⁠Rahul Singh Rajput - Head Of Sports
6. ⁠Deepak Raj Purohit - Head of Operations 
7. Sanjana - Head of Hospitality 
8. ⁠Rahul Dasari - Head of Sponsorship
*/
const TEAM_MEMBERS = [
  {
    id: 1,
  ...
  {
    id: 7,
    name: "Deepak Raj Purohit",
    role: "Head of Operations",
    image: "/images/team/manasmalla.png",
  },
  {
    id: 8,
    name: "Sanjana Dakshhani Thota",
...
export default function HostsSection() {
  ...
  return (
    <section className="w-full bg-black md:py-20 text-white overflow-hidden">
      <div className="container relative mx-auto px-4">
        <div className='md:absolute md:top-0'>
          ...
          <img src="/images/signature.png" className='h-16 md:block hidden' />
        </div>

        {/* Pagination Dots */}
        <div className="absolute w-max md:w-full bottom-8 md:-bottom-8 right-8 md:right-[unset] md:left-8 z-20 flex items-center gap-4">
          {TEAM_MEMBERS.map((_, idx) => (
            <button
              key={idx}
              onClick={() => setSlide(idx)}
              className={`cursor-pointer transition-all duration-300 rounded-full ${idx === currentIndex
        ...
        <div className=" flex-wrap justify-center gap-8">
          ...
          <div className="w-full h-96 relative flex items-end justify-center pb-10">
            <div className="translate-y-36 md:translate-y-56 md:translate-x-48 w-full lg:w-2/3 h-[500px] relative flex items-center justify-center perspective-1000">
              <div className="md:mask-[linear-gradient(270deg,rgba(0,0,0,0)_-30%,#000_56.24%,rgba(0,0,0,0)_98.3%)] relative w-full h-full flex items-center justify-center">
                  ...
                  {TEAM_MEMBERS.map((member, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {position === 'center' && (
                          <div className="absolute bottom-0 left-0 w-full bg-black/70 p-4 px-6 md:hidden backdrop-blur-sm">
