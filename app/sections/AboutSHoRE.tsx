...
export default function AboutShoreSection() {
  return (
    <section id="about-shore" className="w-full bg-black py-20 text-white relative overflow-hidden">
      ...
      {/* bg-[#0a192f] */}
      <div className="absolute -bottom-18 right-0 w-[30%] h-28 bg-[#0a192f] transform skew-y-8 origin-bottom-right"></div>
      <div className="absolute bottom-0 left-0 w-[70%] h-24 bg-[#0a192f] transform -skew-y-5 origin-bottom-right"></div>
    </section>
  );
}